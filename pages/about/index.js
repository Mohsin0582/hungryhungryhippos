        ...
        <>
         {/* <div className="absolute top-0 left-0 z-10 h-full bg-blue-400">
                        <div className="h-full flex flex-col justify-center">
                            <Image src="/imgs/hippo-pink.png" alt="home image" layout="responsive" objectFit="contain" width="100%" height="60%" />
                        </div>
                    </div> */}
            {/* <div className="h-full">
                <div className="bg-[url('/imgs/about-bg.png')] bg-auto bg-no-repeat bg-center h-full bg-red-400">
                    <div className="h-full flex justify-center items-center bg-red-400">
                        <Image src="/imgs/logo-big.png" alt="large logo image" layout="responsive" objectFit="contain" width="60%" height="60%" />
                    </div>
